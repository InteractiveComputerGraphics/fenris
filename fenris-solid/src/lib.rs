...
use fenris::nalgebra::{MatrixMN, DimName, Scalar, DefaultAllocator, RealField, VectorN};
use fenris::allocators::{SmallDimAllocator};
use fenris::assembly::operators::{EllipticEnergy, Operator, EllipticOperator, EllipticContraction};
    ...
    DefaultAllocator: SmallDimAllocator<T, GeometryDim>
{
    ...
    fn compute_energy_density(&self,
    ...
    /// $$
    fn compute_stress_contraction(&self,
                                  deformation_gradient: &MatrixMN<T, GeometryDim, GeometryDim>,
...
where
    ...
    DefaultAllocator: SmallDimAllocator<T, GeometryDim>
{
    fn compute_elliptic_operator(&self,
                                 gradient: &MatrixMN<T, GeometryDim, GeometryDim>,
                                 parameters: &Self::Parameters)
        ...
        DefaultAllocator: SmallDimAllocator<T, GeometryDim>
{
    fn contract(&self,
                ...
                a: &VectorN<T, GeometryDim>,
                b: &VectorN<T, GeometryDim>,
                parameters: &Self::Parameters) -> MatrixMN<T, Self::SolutionDim, Self::SolutionDim> {
        let f = gradient.transpose();

...
pub fn triangle<T: RealField>(strength: usize) -> Result<QuadraturePair2d<T>, QuadratureError> {
    ...
    Ok(quadrature::convert_quadrature_rule_from_2d_f64((
        weights, points,
    )))
}

pub fn quadrilateral<T: RealField>(
    strength: usize,
) -> Result<QuadraturePair2d<T>, QuadratureError> {
...
pub fn tetrahedron<T: RealField>(strength: usize) -> Result<QuadraturePair3d<T>, QuadratureError> {
    ...
    Ok(quadrature::convert_quadrature_rule_from_3d_f64((
        weights, points,
    )))
}

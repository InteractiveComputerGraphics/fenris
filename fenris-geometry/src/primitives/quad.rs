use crate::{
    AxisAlignedBoundingBox2d, BoundedGeometry, ConvexPolygon3d, Distance, GeneralPolygon2d, Triangle, Triangle2d,
};
use itertools::izip;
    ...
    T: RealField,
{
    fn distance(&self, point: &Point2<T>) -> T {
        ...
        GeneralPolygon2d::from_vertices(self.0.to_vec()).distance(point)
    }
}
